...
<head>
<meta charset="utf-8">
<title>优秀社团-湖北汽车工业学院社团工作网站</title>
<META Name="SiteName" Content="四川大学学生社团工作网站" />
<META Name="SiteDomain" Content="sau.scu.edu.cn" />
<META Name="ColumnName" Content="优秀社团" />
...
<link rel="stylesheet" Content-type="text/css" href="${pageContext.request.contextPath}/css_other/sys.css">
...
<script type="text/javascript">_jsq_(1040,'/list.jsp',-1,1615781732)</script>
...
<body>
	...
	<div class="head">
		...
		<div class="head-bottom wrap">
			...
			<a href="../index.jsp"><img src="${pageContext.request.contextPath}/images/xiaohui.png" width="74"
	...
	<div class="nav">
		<div class="wrap">
			<ul>
				...
				<li><a href="#" class="hover">社团快讯</a></li>
			</ul>
		</div>
	</div>
	<!--内页banner-->
	...
	<div class="padding-40 cleafix">
		<div class="wrap cleafix">
			<div class="nrfl fl">
				<h3>社团资讯</h3>
				<ul class="cleafix"><li class="hoverl"><a href="#" title="社团资讯" class="hover">社团资讯</a></li></ul>
			</div>
			<div class="nrfr fr cleafix">
				...
				<ul class="list cleafix">
					<c:if test="${not empty notices }">
						...
						<li id="line_u10_0">
							<span class="fr gay"><fmt:formatDate value="${notice.launch }" pattern='yyyy-MM-dd'/></span>
							<a href="login?status=${login.status }" onclick="return isLogin();" target="_blank" title="${notice.content }">${notice.title }</a>
						</li></c:forEach>
					</c:if>
					<c:if test="${empty notices }">
						<li id="line_u10_0">
							<font color="red" style="font-size: 15px;">暂无数据</font>
						</li>
					</c:if>
				</ul>
				<div class="pb_sys_common pb_sys_normal pb_sys_style2" style="margin-top: 10px; text-align: center;">
					<span class="p_pages"><span class="p_first_d p_fun_d">首页</span>
					<span class="p_prev_d p_fun_d">上页</span><span class="p_no_d">1</span>
					<span class="p_next_d p_fun_d">下页</span><span class="p_last_d p_fun_d">尾页</span></span>
				</div>
	...
	<div class="foot">
		<div class="wrap cleafix">
			...
			<div class="img_li fl">
				<a href="http://www.scu.edu.cn/" onclick="_addDynClicks(&#34;wbimage&#34;, 1615781732, 55396)"
			...
			<div class="box-search fr cleafix">
				<select onchange="_openSelectLink(this, 'value', 'addclicks')"
					class="box_1">
					<option>--校内链接--</option>
					<option value="http://lib.scu.edu.cn/" addclicks="_addDynClicks(&#34;wburl&#34;, 1615781732, 63012)">湖北汽车工业学院图书馆</option>
					<option value="http://xsc.scu.edu.cn/" addclicks="_addDynClicks(&#34;wburl&#34;, 1615781732, 63013)">湖北汽车工业学院党委学生工作部</option>
					<option value="http://jwc.scu.edu.cn/" addclicks="_addDynClicks(&#34;wburl&#34;, 1615781732, 63011)">湖北汽车工业学院教务处</option>
					<option value="http://tuanwei.scu.edu.cn/" addclicks="_addDynClicks(&#34;wburl&#34;, 1615781732, 63650)">湖北汽车工业学院校团委</option>
				</select> <select onchange="_openSelectLink(this, 'value', 'addclicks')" class="box_1" style="margin-top: 0;">
					<option>--校外链接--</option>
