	...
	<div class="nav">
		<div class="wrap">
			<ul>
				...
				<li><a href="getClubList" class="hover">活力社团</a></li>
	...
	<div class="padding-40 cleafix">
		<div class="wrap cleafix">
			<div class="nrfl fl">
				<h3>社团信息</h3>
				<ul class="cleafix">
					<li class="hoverl"><a href="#" title="活力社团" class="hover">社团信息</a></li>
				</ul>
			</div>
			<div class="nrfr fr cleafix">
				...
				<ul class="list cleafix">
					<c:if test="${not empty clubInfo }">
						<!-- 显示社团活动的详细信息 -->
						<li id="line_u10_0">
							<span class="fr gay"></span>
							<a href="#">社团名称：${clubInfo.clubName }</a>
						</li>
						<li id="line_u10_0">
							<a href="#">社团人数：${clubInfo.number }</a>
						</li>
						<li id="line_u10_0">
							<a href="#">类型：${clubInfo.type }</a>
						</li>
						<li id="line_u10_0">
							<a href="#">指导老师：${clubInfo.instructor }</a>
						</li>
						<li id="line_u10_0">
							<a href="#">社团简介：${clubInfo.introduction }</a>
						</li>
						<li id="line_u10_0">
							<a href="#">社团负责人：${clubInfo.president }</a>
						</li>
						<li id="line_u10_0">
							<a href="#">成立日期：<font color="green"><fmt:formatDate value="${clubInfo.createDate }" pattern='yyyy-MM-dd'/></font></a>
						</li>
						<li id="line_u10_0">							
							<a href="login?status=${login.status }" onclick="return isLogin();" title="点击进入个人页面" style="color: red;">进入后台</a>							
						</li>
					</c:if>
