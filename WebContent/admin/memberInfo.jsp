    ...
    <c:if test="${modify eq 'success' }">
		<div class="alert alert-inline">
			...
			<div class="alert-body">				
				<font size="4px" color=red>&nbsp;&nbsp;&nbsp;<b>操作成功！</b></font>
			</div>
		</div>
	</c:if>
	
    <form:form action="${pageContext.request.contextPath}/MemberInfoUpdate" modelAttribute="login" method="post" enctype="multipart/form-data">
	    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
	    
	      <tr style="height:80px;">
	        <td align="center" valign="middle" class="borderright borderbottom bggray">
	          <img src="${pageContext.request.contextPath}/header/头像.png" width="60px" height="60px" style="border-radius: 50%;">
	        </td>
	      ...
	      <tr>
	        ...
	        <form:input path="id" class="text-word" readonly="true"/>
	        
	        <td align="right" valign="middle" class="borderright borderbottom bggray">真实姓名：</td>
	        <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">	        
	        <form:input path="name" class="text-word" readonly="true"/>
	      ...
	      <tr>
	        ...
	        <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        <form:input path="nickname" class="text-word"/></td>
			...
			<%-- <input name="gender" value="${login.gender eq 1?'男':'女'}" class="text-word" disabled="disabled"/> --%>	        
	        </td>
	      </tr>
