...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：用户管理&nbsp;&nbsp;>&nbsp;&nbsp;审核社团列表</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
		   ...
		   <span style="line-height: 30px;font-size: 18px;height: 30px;">申请注册社团列表</span>
		   </td>
	   	</tr>
	</table>
    </td>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <c:forEach items="${applicationInfo }" var="club" varStatus="status">
      <tr class="bggray" onMouseOut="this.style.backgroundColor='#f9f9f9'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom">${club.name }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${club.proposer }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${club.submitTime}</td>
        <td align="center" valign="middle" class="borderright borderbottom">${club.status }</td>
