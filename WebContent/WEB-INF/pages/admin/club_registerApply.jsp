  ...
  <!-- 显示所有的社团信息列表 -->
	  ...
	  <tr>
	    ...
	    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
	      ...
	      <c:forEach items="${applyClubs }" var="registered" varStatus="status">
	      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        ...
	        <td align="center" valign="middle" class="borderright borderbottom">${registered.applicant}</td>
	        ...
	        <!-- 日期格式化处理 -->
	        <td align="center" valign="middle" class="borderright borderbottom"><fmt:formatDate value="${registered.applyDate }" pattern='yyyy-MM-dd'/></td>
	        <td align="center" valign="middle" class="borderbottom">
		        <a href="add.jsp" style="text-decoration: none;" target="mainFrame" onFocus="this.blur()" class="add">同意</a>
		        <span class="gray">&nbsp;|&nbsp;</span>
		        <a href="add.jsp" style="text-decoration: none;" target="mainFrame" onFocus="this.blur()" class="add">拒绝</a>
	        </td>
	      </tr>
	      </c:forEach>
