...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：消息通知&nbsp;>&nbsp;申请报名活动的处理结果</td>
  </tr>
  <tr>
    ...
    <form id="sign_act" method="post" action="" >
	  <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
	      <tr style="color:black;background-color: yellow;">
	        ...
	        <th align="center" valign="middle">备注信息</th>
	        <th align="center" valign="middle" class="borderright">处理状态</th>	        
	      </tr>
	      <c:forEach items="${result }" var="actSign" varStatus="status">
	      <tr class="bggray" onMouseOut="this.style.backgroundColor='#f9f9f9'" onMouseOver="this.style.backgroundColor='#edf5ff'">	      
	        ...
	        <td align="center" valign="middle" class="borderright borderbottom">${actSign.uid }</td>
	        <td align="center" valign="middle" class="borderright borderbottom">${actSign.actid }</td>
	        <td align="center" valign="middle" class="borderright borderbottom">${actName[status.index] }</td>
	        <td align="center" valign="middle" class="borderright borderbottom">${actSign.remarks }</td>
	        <!-- 处理状态 -->
	        <td align="center" valign="middle" class="borderright borderbottom">
	        <c:choose>
		        <c:when test="${actSign.finished eq 0}"><font color="orange">待处理</font></c:when>
		        <c:when test="${actSign.finished eq 1}"><font color="green">已报名</font></c:when>
		        <c:when test="${actSign.finished eq 2}"><font color="red">已拒绝</font>
		        <a href="toSignAct?uid=${actSign.uid }&actid=${actSign.actid }" style="text-decoration: none;color: orange;" 
	        		target="mainFrame" onFocus="this.blur()">再次申请？</a>
	        	</c:when>
