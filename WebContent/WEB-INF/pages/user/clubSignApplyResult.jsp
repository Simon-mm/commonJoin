...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：消息通知&nbsp;>&nbsp;申请入团的处理结果</td>
  </tr>
  <tr>
    ...
    <form id="sign_act" method="post" action="" >
	  <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
	      ...
	      <c:forEach items="${result }" var="clubSign" varStatus="status">
	      <tr class="bggray" onMouseOut="this.style.backgroundColor='#f9f9f9'" onMouseOver="this.style.backgroundColor='#edf5ff'">	      
	        ...
	        <td align="center" valign="middle" class="borderright borderbottom">${clubSign.uid }</td>
	        <td align="center" valign="middle" class="borderright borderbottom">${clubSign.cid }</td>
	        <td align="center" valign="middle" class="borderright borderbottom">${clubSign.role}</td>
	        <td align="center" valign="middle" class="borderright borderbottom">${clubSign.remarks}</td>
	        <!-- 处理状态 -->
	        <td align="center" valign="middle" class="borderright borderbottom">
	        <c:choose>
		        <c:when test="${clubSign.status eq 0}"><font color="orange">待处理</font></c:when>
		        <c:when test="${clubSign.status eq 1}"><font color="green">已录取</font></c:when>
		        <c:when test="${clubSign.status eq 2}"><font color="red">已拒绝</font>
		        <a href="toSignClub?uid=${clubSign.uid }&cid=${clubSign.cid }" style="text-decoration: none;color: green;" 
	        		target="mainFrame" onFocus="this.blur()" class="add">再次申请？</a></c:when>
