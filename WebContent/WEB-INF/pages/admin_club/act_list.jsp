  ...
  <tr>
	<td align="left" valign="top">
	   <table width="" border="0" cellspacing="0" cellpadding="0" id="search">
		   ...
		   <td width="10%" align="right" valign="middle" style="text-align:right; width:150px;">
	  	   <a href="toEditNewAct?cname=${cname }&flag=0" style="text-decoration: none;" target="mainFrame" onFocus="this.blur()" class="add">发布活动</a>
	  	   </td>
	   	</tr>
	   </table>
	</td>
	...
	<td align="left" valign="top">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
			...
			<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
		        ...
		        <td align="center" valign="middle" class="borderright borderbottom">${cnum[status.index]} / ${act.actNum}</td>
				...
				<c:choose>
					<c:when test="${act.isPass eq 0}"><font color="red">活动尚未发布</font></c:when>
				...
				<td align="center" valign="middle" class="borderright borderbottom">
				<c:choose>
					<c:when test="${act.isPass eq 0}"><font color="red">请到通知管理查看详情</font></c:when>
					...
					<c:when test="${actStatus[status.index] eq 2}"><font color="grey">活动已结束，不可报名</font></c:when>
